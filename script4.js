...
for (const bookObject in library) {

let book = library[bookObject];
    if (book.alreadyRead == true) {
    console.log(`${book.title} by ${book.autor} You already read`)
    } else {
        console.log(`${book.title} by ${book.autor} You still need to read`)
    }
